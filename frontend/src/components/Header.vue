  ...
  <div class="mx-auto">
    <header class="container text-midnight py-4 px-6 flex justify-between items-center">
      ...
      <div class="profile relative">
        <FwbAvatar v-if="isLoggedIn" bordered :img="user.profileURL" rounded class="w-10 h-10 cursor-pointer"
        ...
        <div v-if="isLoggedIn" v-show="showDropdown"
          ...
          <div class="name-container flex my-3 mx-3">
            <img :src="user.profileURL" alt="profile-pic" class="rounded-full h-8 w-8" />
