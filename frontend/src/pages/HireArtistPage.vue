    ...
    <div class="artist-profile bg-white rounded-lg shadow-lg p-6 items-center font-dm-sans">
      ...
      <div class="profile-container my-5 flex items-center">
        <div class="box-pic w-12 h-12">
          <img src="../assets/profile_sample.png" alt="Artist" class="rounded-full h-auto w-auto" />
        </div>
      ...
      <div class="flex items-center mt-6">
        ...
        <div class="mx-4">
          <img src="../assets/profile_sample.png" alt="Your Image" class="w-16 h-16 rounded-full" />
        </div>
