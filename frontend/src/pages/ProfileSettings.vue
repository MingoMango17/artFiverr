<template>
  <div class="main-container font-dm-sans">
    <div
      class="cover-photo bg-gradient-to-r from-emerald-500 to-emerald-900 w-full h-96 relative"
    >
      <div
        class="image-container absolute z-15 bottom-0 left-0 mx-10 -my-20 bg-white p-3 rounded-full"
      >
        <img
          src="../assets/sample-art.jpg"
          alt=""
          class="rounded-full w-40 h-40 hover:cursor-pointer"
        />
      </div>
    </div>
    <div class="upper-container flex mx-64 mt-8">
      <div class="name-avail flex-1 block">
        <h1 class="text-3xl font-bold">Zian Rinzler Valles</h1>
        ...
        <div class="flex items-center relative">
          ...
          <img
            ...
            alt=""
            class="w-3 h-3 hover:cursor-pointer"
        ...
        <div
          v-show="showDropdown"
          class="absolute bg-white w-36 z-10 rounded-lg mt-1 py-2 px-3 "
        >
          <div class="options">
            <div class="availcontainer hover:bg-gray-200 flex hover:cursor-pointer rounded-lg py-1" @click="selectOption('Available')">
              <img src="../assets/online.png" alt="check" class="w-5 h-5" />
              <p class="mx-3">Available</p>
            </div>
            <div class="availcontainer flex hover:bg-gray-200  hover:cursor-pointer rounded-lg"  @click="selectOption('Unavailable')">
    ...
    <div class="lower-container mt-28 mx-10">
      <div class="first-container flex">
        ...
        <div class="right-side ml-72 flex-1">
          ...
          <div class="input-name my-10 w-full">
            <fwb-input v-model="facebook" label="Facebook" placeholder="" />
          </div>
          <div class="input-phone my-10 w-full">
            <fwb-input v-model="instagram" label="Instagram" placeholder="" />
          </div>
        </div>
      </div>
