<template>
  <form @submit.prevent="submitForm">
    <div class="main-container font-dm-sans">
      <div class="cover-photo bg-gradient-to-r from-emerald-500 to-emerald-900 w-full h-96 relative">
      ...
      <div class="upper-container flex mx-64 mt-8">
        <div class="name-avail flex-1 block">
          ...
          <div class="flex items-center relative">
            ...
            <img src="../assets/arrow-down.png" alt="" class="w-3 h-3 hover:cursor-pointer" @click="toggleDropdown" />
          </div>
        ...
        <div class="second-container flex">
          <div class="left-side flex-1">
            ...
            <div class="my-10 flex">
              <div class="minimum">
                <fwb-input v-model="userData.priceRange_min" label="Minimum" placeholder="Php 0" size="sm" required type="number" />
              </div>

              <div class="maximum ml-10">
                <fwb-input v-model="userData.priceRange_maximum" label="Maximum" placeholder="Php 0" size="sm" type="number"/>
              </div>
            </div>
          </div>
          <div class="right-side ml-72 flex-1">
